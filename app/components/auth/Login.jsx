...
function Login() {
  ...
  return (
    <div className="flex w-screen h-screen justify-center items-center landing-pattern">
      <div className="flex h-min py-25 w-xl flex-col justify-center items-center px-6 bg-white-300 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-stone-200 shadow-2xl">
